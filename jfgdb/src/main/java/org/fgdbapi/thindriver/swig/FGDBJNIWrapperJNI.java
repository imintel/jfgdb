...
public class FGDBJNIWrapperJNI {
	...
	public final static native int CloseGeodatabase(long jarg1,
			Geodatabase jarg1_);
	...
	public final static native int Geodatabase_GetRelatedDatasets(long jarg1,
			...
			long jarg5, VectorOfWString jarg5_);
	...
	public final static native int Geodatabase_GetChildDatasetDefinitions(
			...
			long jarg4, VectorOfString jarg4_);

	public final static native int Geodatabase_GetRelatedDatasetDefinitions(
			long jarg1, Geodatabase jarg1_, String jarg2, String jarg3,
			String jarg4, long jarg5, VectorOfString jarg5_);
	...
	public final static native int Geodatabase_CompactDatabase(long jarg1,
			Geodatabase jarg1_);
	...
	public final static native void Geodatabase_createFeatureDataset(
			long jarg1, Geodatabase jarg1_, String jarg2);
	...
	public final static native int Table_CreateSubtype(long jarg1,
			Table jarg1_, String jarg2);

	public final static native int Table_AlterSubtype(long jarg1, Table jarg1_,
			String jarg2);

	public final static native int Table_DeleteSubtype(long jarg1,
			Table jarg1_, String jarg2);

	public final static native int Table_EnableSubtypes(long jarg1,
			Table jarg1_, String jarg2, String jarg3);

	public final static native int Table_SetDefaultSubtypeCode(long jarg1,
			Table jarg1_, int jarg2);

	public final static native int Table_DisableSubtypes(long jarg1,
			Table jarg1_);
	...
	public final static native String Table_getDefinition(long jarg1,
			Table jarg1_);
	...
	public final static native long Table_createRowObject(long jarg1,
			Table jarg1_);
	...
	public final static native long Table_search__SWIG_0(long jarg1,
			Table jarg1_, String jarg2, String jarg3, long jarg4,
			Envelope jarg4_, boolean jarg5);
	...
	public final static native long EnumRows_getFields(long jarg1,
			EnumRows jarg1_);
	...
	public final static native int SpatialReference_GetXYFalseOrigin(
			long jarg1, SpatialReference jarg1_, long jarg2, long jarg3);

	public final static native int SpatialReference_SetXYFalseOrigin(
			long jarg1, SpatialReference jarg1_, double jarg2, double jarg3);

	public final static native int SpatialReference_GetXYResolution(long jarg1,
			SpatialReference jarg1_, long jarg2);

	public final static native int SpatialReference_SetXYResolution(long jarg1,
			SpatialReference jarg1_, double jarg2);

	public final static native int SpatialReference_SetXYTolerance(long jarg1,
			SpatialReference jarg1_, double jarg2);

	public final static native int SpatialReference_GetZFalseOrigin(long jarg1,
			SpatialReference jarg1_, long jarg2);

	public final static native int SpatialReference_SetZFalseOrigin(long jarg1,
			SpatialReference jarg1_, double jarg2);

	public final static native int SpatialReference_GetZResolution(long jarg1,
			SpatialReference jarg1_, long jarg2);

	public final static native int SpatialReference_SetZResolution(long jarg1,
			SpatialReference jarg1_, double jarg2);

	public final static native int SpatialReference_SetZTolerance(long jarg1,
			SpatialReference jarg1_, double jarg2);

	public final static native int SpatialReference_GetMFalseOrigin(long jarg1,
			SpatialReference jarg1_, long jarg2);

	public final static native int SpatialReference_SetMFalseOrigin(long jarg1,
			SpatialReference jarg1_, double jarg2);

	public final static native int SpatialReference_GetMResolution(long jarg1,
			SpatialReference jarg1_, long jarg2);

	public final static native int SpatialReference_SetMResolution(long jarg1,
			SpatialReference jarg1_, double jarg2);
	...
	public final static native int FieldDef_SetName(long jarg1,
			FieldDef jarg1_, String jarg2);

	public final static native int FieldDef_SetAlias(long jarg1,
			FieldDef jarg1_, String jarg2);

	public final static native int FieldDef_SetType(long jarg1,
	...
	public final static native String FieldDef_getName(long jarg1,
			FieldDef jarg1_);

	public final static native boolean FieldDef_isNullable(long jarg1,
			FieldDef jarg1_);

	public final static native int FieldDef_getLength(long jarg1,
			FieldDef jarg1_);
	...
	public final static native int IndexDef_SetName(long jarg1,
	...
	public final static native String IndexDef_getName(long jarg1,
			IndexDef jarg1_);
	...
	public final static native void Envelope_SetEmpty(long jarg1,
			Envelope jarg1_);
